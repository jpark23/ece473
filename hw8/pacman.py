...
def loadAgent(pacman, nographics):
  ...
  for moduleDir in pythonPathDirs:
    ...
    moduleNames = [f for f in os.listdir(moduleDir) if f.endswith('gents.py') or f.endswith('submission.py')]
  ...
  raise Exception('The agent ' + pacman + ' is not specified in any *Agents.py or *submission.py.')

def replayGame( layout, actions, display ):
    import hw8_submission, ghostAgents
